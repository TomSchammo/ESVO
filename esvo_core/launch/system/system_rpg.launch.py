#!/usr/bin/env python3
"""
ROS2 launch file for ESVO system with RPG dataset configuration.
"""
...
def generate_launch_description():
    ...
    # Mapping node
    mapping_params_file = os.path.join(esvo_core_share, 'cfg', 'mapping', 'mapping_rpg.yaml')
    esvo_mapping = Node(
        package='esvo_core',
    ...
    # Tracking node
    tracking_params_file = os.path.join(esvo_core_share, 'cfg', 'tracking', 'tracking_rpg.yaml')
    esvo_tracking = Node(
        package='esvo_core',
